...
## 🔧 Superpowers 技能配置 (2026-03-21)

**硬性要求**: 所有涉及源代码修改的工作，**必须**使用 `superpowers` 技能。

### 强制使用场景
- 构建新功能或应用
- 调试 Bug 或测试失败
- 添加/修改功能（用户说 "let's build", "help me plan", "I want to add X", "this is broken"）
- 完成功能分支
...
**核心原则**:
- TDD 强制: 先写测试 → 看失败 → 实现 → 看通过 → 提交
- 设计先行: 未经批准不得编码
- 双阶段审查: spec-reviewer + code-quality reviewer
- 子代理执行: 使用 `sessions_spawn` 派遣子代理

**技能文档**: `/root/.openclaw/workspace/skills/superpowers/SKILL.md`
