...
### 每日自我反思系统
**创建时间**: 2026-03-23  
**目的**: 每天北京时间03:00自动执行自我反思，检查记忆文件、回顾过去24小时的交互、整理patterns和corrections  
**执行内容**:
1. 检查记忆文件（MEMORY.md、AGENTS.md、TOOLS.md）
2. 回顾过去24小时的交互记录
3. 整理发现的patterns和corrections
4. 执行记忆压缩和归档
5. 更新索引  
**实现方式**: 待配置cron任务或heartbeat触发，输出到 `memory/YYYY-MM-DD.md`
